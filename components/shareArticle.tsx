        ...
        <DialogContent>
            <DialogHeader>
                ...
                <div className='py-6 min-h-72 flex flex-col gap-4 items-center justify-center'>
                    <img src={article.images.length > 0 ? `${process.env.NEXT_PUBLIC_API}image/${article.images[0].id}`: "/images/no-image.jpg"} alt={article.title} className="w-full h-auto aspect-video max-w-80 object-cover rounded-md"/>
