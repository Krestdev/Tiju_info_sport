    ...
    return (
        <div className={`${totalPages > 1 ? "w-full flex justify-end" : "hidden"}`}>
            <div className="flex flex-row gap-4">
                ...
                {currentPage - 1 > 0 && <Button onClick={() => goToPage(currentPage - 1)} className='bg-transparent rounded-none shadow-none hover:bg-gray-50 !border-none  !text-black px-3 py-1'>{currentPage - 1} </Button>}
