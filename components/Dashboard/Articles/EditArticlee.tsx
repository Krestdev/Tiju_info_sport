...
const formSchema = z
  .object({
    title: z
      .string({ message: "Ce champ ne peut être vide" })
      .max(250, { message: "Le titre doit comporter moins de 250 caractères" }),
    featuredImage: z.string({ message: "Veuillez renseigner une image" }),
    excerpt: z.string().max(250, {
      message: "Le résumé doit comporter moins de 250 caractères",
    }),
  ...
  .refine(
    ...
    {
      message: "La publication doit être programmé au moins 15 dans le futur",
      path: ["time"],
    },
  );
...
function EditArticlee({ children, donnee }: Props) {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      time: donnee.publish_on
        ? new Date(donnee.publish_on).toTimeString().slice(0, 5)
        : "09:00",
      delay: false,
      ...
      toast({
        ...
        description: (
          <pre>
            <p>
              {
                "Un erreur s'est produite lors de l'enregistrement de votre article."
              }
            </p>
        ...
        <div className="flex flex-col gap-5">
          <Form {...form}>
            <form
              ...
              className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-y-5 gap-x-7"
            >
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          ...
                          className="h-[60px] text-2xl leading-[130%]"
                        />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                    ...
                    <FormItem className="flex gap-3 items-center">
                      ...
                      <div className="flex flex-col">
                        ...
                        <span className="text-sm text-paragraph">
                          {"Activez pour mettre l'article à la Une"}
                        </span>
                      </div>
                      <FormMessage />
                    </FormItem>
                    ...
                    render={({ field }) => (
                      <FormItem className="flex gap-3 items-center">
                        ...
                        <div className="flex flex-col">
                          ...
                          <span className="text-sm text-paragraph">
                            {
                              "Désactiver pour publier maintenant et activer pour définir une date de publication"
                            }
                          </span>
                        </div>
                        <FormMessage />
                        ...
                        <PopoverTrigger asChild>
                          <FormControl>
                            <Button
                              variant={"outline"}
                              family={"sans"}
                              className={cn("border-input justify-between")}
                            >
                              {field.value ? (
              ...
              <span className="col-span-1 lg:col-span-2">
                <Button
                  ...
                  disabled={postArticle.isPending}
