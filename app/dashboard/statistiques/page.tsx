        ...
        <div className="flex flex-col gap-5 px-7 py-10">
            ...
            <div className="flex flex-row gap-5">
                ...
                <Compo
                    ...
                    setValue={(val) => handleChange("publication", val)} isLink={false} link={""}                >
                ...
                <Compo
                    ...
                    setValue={(val) => handleChange("vuesSite", val)} isLink={false} link={""}                >
            ...
            <div className="grid grid-cols-3 gap-5">
                ...
                <Compo
                    ...
                    setValue={(val) => handleChange("vuesPeriode", val)} isLink={false} link={""}                >
                    <LineChar value={values.vuesPeriode} />
                </Compo>
                <Compo
                    texte={"Vues par période"}
                    page={"Tous les articles"}
                    ...
                    setValue={(val) => handleChange("vuesPlateforme", val)} isLink={false} link={""}                >
                    <BarChar value={values.vuesPlateforme} />
                </Compo>
                <Compo
                    texte={"Vues par période"}
                    page={"Tous les articles"}
                    ...
                    setValue={(val) => handleChange("plusVues}", val)} isLink={false} link={""}                >
                    <MostPopular value={values.plusVues} />
                </Compo>
            </div>
            <div className="flex flex-row gap-5">
                ...
                <Compo
                    ...
                    width={"max-w-[400px] w-full"}
                    value={values.vues}
                    setValue={(val) => handleChange("vues}", val)} isLink={false} link={""}                >
                    <LineChar value={values.vues} />
                </Compo>
                <Compo
                    texte={"Vues par période"}
                    page={"Tous les articles"}
                    ...
                    setValue={(val) => handleChange("vuesCategorie}", val)} isLink={false} link={""}                >
                    <CircChar />
                </Compo>
            </div>
        </div>
