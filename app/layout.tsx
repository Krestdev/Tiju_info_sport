...
const fontSans = Open_Sans({
  subsets: ["latin"],
  variable: "--font-sans",
}); /**Ubuntu doesnt display well for some reason, so we better use this one :/ */
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    keywords: [
      `${settings[0]?.company || "Tyju Infosports"}`,
      "sport",
      "football",
      "cameroun",
      "MTN Elite one",
  ...
  return (
    <html suppressHydrationWarning>
      <head>
        <Script
          async
          src={`https://www.googletagmanager.com/gtag/js?id=${idC}`}
        ></Script>
